...
import { h1, heightLogo } from "../../sizes/Sizes";
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <a href={`${data?.facebook ? data?.facebook : 'https://facebook.com'}`} id="facebook" style={{ color: 'white' }} >
                                        <FacebookIcon />
                                    </a>
                                </Avatar>
                            </Grid>
                            ...
                            >
                                ...
                                >
                                    <a href={`${data?.linkedin ? data?.linkedin : `https://linkedin.com`}`} id="linkedin" style={{ color: 'inherit' }} >
                                        <LinkedInIcon />
                                    </a>
                                </Avatar>
                            </Grid>
                            ...
                            >
                                ...
                                >
                                    <a href={`${data?.instagram ? data?.instagram : `https://instagram.com`}`} id="instagtam" style={{ color: 'white' }} >
                                        <InstagramIcon />
                                    </a>
                                </Avatar>
                            </Grid>
                            ...
                            >
                                ...
                                >
                                    <a href={`${data?.youtube ? data?.youtube : `https://youtube.com`}`} id="instagtam" style={{ color: 'white' }} >
                                        <YouTubeIcon />
                                    </a>
                                </Avatar>
                            </Grid>
                    ...
                    >
                        ...
                        >
                            <Typography
                                ...
                                px={2}
                            >
                                {data?.phone_no ? data?.phone_no : 'phone number'}
                            </Typography>
                            <TextField
                                fontWeight={600}
                                // color="#510C00"
